    ...
    for rr in range (5,6):
        ...
        # FUNCION PARA ORDENAR 3 NUMEROS PARA TENER EL BEST FIT.
            ...
            def cont_aleatorio(self, cajas_pe):
                ...
                #Adicionarle a la triple el best FIT
                            ...
                            if esp_peq != None:
                                ...
                                if len(cajas_buenas) > 0:
                                    ...
                                    for j in cajas_buenas:
                                        ...
                                        #Calculo el perfect_fit
                                        
                                        if perfect_fit(j,esp_peq,3):
                                            d_s=0
                                        elif perfect_fit(j,esp_peq,2):
                                            d_s=1
                                        elif perfect_fit(j,esp_peq,1):
                                            d_s=2
                                        else:
                                            d_s=3
                                        
                                        ##Calculo el tema de la uti
                                        
                                        #calculo de cuantas entran en x
                                        x_c=math.floor((esp_peq.x2-esp_peq.x1)/j.x)
                                        y_c=math.floor((esp_peq.y2-esp_peq.y1)/j.y)
                                        z_c=math.floor((esp_peq.z2-esp_peq.z1)/j.z)
                                        ...
                                        esp_max_vol_p=(esp_peq.z2-esp_peq.z1)*(esp_peq.x2-esp_peq.x1)*(esp_peq.y2-esp_peq.y1)
                                        num_cajas=x_c*y_c*z_c
                                        vol_caja=j.z*j.x*j.y
                                        
                                        uti_ampliada=1-(vol_caja*num_cajas)/esp_max_vol_p
                                        
                                        resp = self.sort_3(d_s,uti_ampliada,abs(j.x+esp_peq.x1-esp_peq.x2), abs(
        ...
        for i in range(0, 2100):
            ...
            cajas_empacadas.to_excel('cut_1_final/buf_'+str(global_buffer)+'_rea_'+str(
        ...
        os.chdir("C:/Users/juan.huertas/OneDrive - LLA/Documentos/Maestria/Tesis/Solution_Resumen/Cut_1_final")
        
        res_data.to_excel('final_summary_boxes_buf_'+str(global_buffer) +
